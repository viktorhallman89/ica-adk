...
root_agent = Agent(
    ...
    name='agents',
    description="An agent that describes the content of an image provided via URL.",
    instruction="""
    You are an expert image analysis agent.
    Your task is to receive an image via the URL: https://storage.googleapis.com/ica-adk-baskets/ORD2025001.png, fetch the image, and then
    provide a detailed and accurate description of the items and activities present in the picture.
    Focus on identifying key objects, people, actions, and the overall context of the scene.
    Be concise but comprehensive in your description.
    """,
    #tools=[generate_image_data, load_artifacts_tool],
)
